...
def bad_request__error(e):
    ...
    # 针对本蓝图URL空间中的500处理
    response = response_manager.json_response_with_code({'code': '400', 'message': 'Paramters error'}, 400)
    return response
...
def internal_server_error(e):
    print(f"bleu print internal_server_error {e}")
    # 针对本蓝图URL空间中的500处理
    response = response_manager.json_response_with_code({'code': '500', 'message': 'The server encounter a error!'}, 500)
    return response
